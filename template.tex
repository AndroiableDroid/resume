...
\begin{itemize}
	\item Proficient in Angular and Java Spring Boot for full-stack development.
	\item Strong problem-solving and debugging skills; experienced in performance tuning.
	\item Team leadership and mentoring experience; effective communicator.
	\item Familiar with CI/CD workflows, unit testing, and cross-functional collaboration.
\end{itemize}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Languages}{Java, TypeScript, JavaScript, Python, C, C++, Bash}{}\n\t\\tableentry{}{SQL}{spaceafter}\\\\
...
% Each job is added with a 
\jobentry
	{Nov 6, 2024 -- Present} % Duration
	{Full Time} % FT/PT (full time or part time)
	{KareXpert Technologies Pvt. Ltd.} % Employer
	{Software Developer} % Job title
	{Working on enterprise healthcare applications using \textbf{Angular} and \textbf{Java Spring Boot}. Responsibilities include:\\
	 $*$ Developing and maintaining modular, testable Angular frontends and reusable components.\\
	 $*$ Implementing RESTful APIs and backend services with Java Spring Boot.\\
	 $*$ Collaborating with product and QA teams; performing code reviews and mentoring junior developers.\\
	 $*$ Troubleshooting, performance tuning, and writing unit/integration tests.\\
	 $*$ Participating in planning, design discussions and team management tasks.} % Description

\jobentry command. Below is an empty one to use as a template:
